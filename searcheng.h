...
private:
    ...
    //       their page/filename
    std::map<std::string, WebPageSet> search_terms;
    std::map<std::string, WebPage*> file_name;
    // Private helper function, for retrieve page
    WebPage* newretrieve_page(const std::string& page_name);
};
