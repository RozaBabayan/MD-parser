...
cmdhandler.o: cmdhandler.cpp cmdhandler.h combiners.h searcheng.h handler.h util.h webpage.h pageparser.h 
	$(CXX) $(CXXFLAGS) $(DEFS) -c -o $@ cmdhandler.cpp
searcheng.o: searcheng.cpp searcheng.h webpage.h pageparser.h txt_parser.h md_parser.h
...
search-shell: search-shell.cpp $(OBJS)
